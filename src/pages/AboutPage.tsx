    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-16">
      ...
      <div className="space-y-4 max-w-3xl border-b border-[var(--border-color)] pb-8">
        ...
        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
          ByteBrothers was founded with a singular conviction: digital web applications should be blistering fast, impeccably styled, and engineered for resilience.
        </p>
      </div>
